...
public final class BowEnchantments {
    ...
    public static final ResourceKey<Enchantment> STORMSHOT = ModEnchantmentHelper.createResourceKey("stormshot");
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
    	...
    	registerStormshot(context, itemsRegistry);
    ...
    private static void registerStormshot(BootstrapContext<Enchantment> context, HolderGetter<Item> itemsRegistry) {
        ...
        ModEnchantmentHelper.register(context, STORMSHOT, builder);
    }
